	...
	<body>
		...
		<div id="show-pessoa" class="content scaffold-show" role="main">
			...
			<ol class="property-list pessoa">
				...
				<li class="fieldcontain">
					<span id="usuario-label" class="property-label"><g:message code="pessoa.usuario.label" default="Usuario" /></span>
				...
				<g:if test="${pessoaInstance?.dataCadastro}">
				<li class="fieldcontain">
					<span id="dataCadastro-label" class="property-label"><g:message code="pessoa.dataCadastro.label" default="Data Cadastro" /></span>
					
						<span class="property-value" aria-labelledby="dataCadastro-label"><g:formatDate date="${pessoaInstance?.dataCadastro}" /></span>
